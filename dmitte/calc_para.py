...
def meteodata(start_date,end_date): 
...
# end_date = '2022-01-01'
# meteo = meteodata(start_date,end_date)
...
class Calc_air():
    ...
    '''
    def __init__(self, pcse_results, start_date, end_date, plant_type, sta, HEG, x):
        self.meteo = meteodata(start_date,end_date)
        self.x  = x                            # 下风向距离,m
        self.sta = sta             # 稳定度分类
...
class Calc_soil(Calc_air):
    ...
    def __init__(self, pcse_results, start_date, end_date, plant_type, sta, HEG, x):
        super ().__init__ (pcse_results, start_date, end_date, plant_type, sta, HEG, x)
...
class Calc_plant(Calc_air):
    ...
    calc_res()      调用本class中所有函数
    '''
    def __init__(self, pcse_results, start_date, end_date, plant_type, sta, HEG, x,drymatter):
        super ().__init__ (pcse_results, start_date, end_date, plant_type, sta, HEG, x)
